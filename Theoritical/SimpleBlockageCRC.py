...
T = T_freq
Freq = f_seq
Freq.tofile("../Data/SBFrequencyRange.csv", sep=",")
R.tofile("../Data/SBReflectionCoefficient.csv", sep=",")
T.tofile("../Data/SBTransmissionCoefficient.csv", sep=",")
...
R.tofile("../Result/SBReflectionCoefficientTime.csv", sep=",")
plt.figure("1")
