...
class AxisLabelDescriptor(SimpleDescriptor):
    ...
    flavor = "label"
    _attrs = (
        'userMinimum', 'userValue', 'userMaximum', 'name', 'elidable', 'olderSibling', 'linkedUserValue', 'labelNames')
...
class BaseDocReader(LogMixin):
    ...
    def readInstances(self, makeGlyphs=True, makeKerning=True, makeInfo=True):
        ...
        for instanceElement in instanceElements:
            self._readSingleInstanceElement(instanceElement, makeGlyphs=makeGlyphs, makeKerning=makeKerning,
                                            makeInfo=makeInfo)
