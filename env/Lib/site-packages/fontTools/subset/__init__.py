...
def subset_glyphs(self, s):
	if self.Format == 1:
		...
		class1_map = [c for c in self.ClassDef1.subset(s.glyphs.intersection(self.Coverage.glyphs), remap=True) if
					  c < self.Class1Count]
...
class Options(object):
	...
	def __init__(self, **kwargs):
		...
		self.name_IDs = [0, 1, 2, 3, 4, 5,
						 6]  # https://github.com/fonttools/fonttools/issues/1170#issuecomment-364631225
