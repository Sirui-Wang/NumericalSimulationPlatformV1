        ...
        while (offsetOK != 1):
            ...
            for glyphRec in self.glyphRecords:
                assert (glyphRec.offset == len(
                    metaData)), "Glyph record offset did not compile correctly! for rec:" + str(glyphRec)
            ...
            for glyphRec in self.glyphRecords:
                for stringRec in glyphRec.stringRecs:
                    assert (stringRec.offset == len(
                        metaData)), "String offset did not compile correctly! for string:" + str(stringRec.string)
