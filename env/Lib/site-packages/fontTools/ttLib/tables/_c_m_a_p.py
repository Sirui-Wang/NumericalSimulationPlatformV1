...
class cmap_format_2(CmapSubtable):
    ...
    def compile(self, ttFont):
        ...
        idRangeOffset = (
                                len(subHeaderList) - 1) * 8 + 2  # offset to beginning of glyphIDArray from first subheader idRangeOffset.
        subheadRangeLen = len(
...
class cmap_format_12_or_13(CmapSubtable):
    ...
    def decompileHeader(self, data, ttFont):
        ...
        assert len(data) == (16 + nGroups * 12) == (
            length), "corrupt cmap table format %d (data length: %d, header length: %d)" % (
