otData = [
    ...
    ('GPOS', [
        ...
        ('LOffset', 'FeatureVariations', None, 'Version >= 0x00010001',
    ...
    ('ContextSubstFormat1', [
        ...
        ('Offset', 'Coverage', None, None, 'Offset to Coverage table-from beginning of Substitution table'),
        (
            'uint16', 'SubRuleSetCount', None, None,
    ...
    ('GDEF', [
        ...
        ('Offset', 'MarkGlyphSetsDef', None, 'Version >= 0x00010002',
    ...
    ('STAT', [
        ...
        ('LOffsetTo(AxisRecordArray)', 'DesignAxisRecord', None, None,
        ...
        ('LOffsetTo(AxisValueArray)', 'AxisValueArray', None, None,
         'Offset in bytes from the beginning of the STAT table to the start of the axes value offset array'),
        ('NameID', 'ElidedFallbackNameID', None, 'Version >= 0x00010001',
    ...
    ('AxisValueFormat4', [
        ...
        ('STATFlags', 'Flags', None, None, 'Flags.'),
        ('NameID', 'ValueNameID', None, None, ''),
        ('struct', 'AxisValueRecord', 'AxisCount', 0,
    ...
    ('ConditionTableFormat1', [
        ...
        ('F2Dot14', 'FilterRangeMinValue', None, None,
    ...
    ('AnchorPointsFormat0', [
        ...
        ('AATLookupWithDataOffset(AnchorGlyphData)', 'Anchors', None, None,
    ...
    ('BaselineFormat0', [
        ...
        ('uint16', 'DefaultBaseline', None, None,
    ...
    ('BaselineFormat2', [
        ...
        ('uint16', 'DefaultBaseline', None, None,
         'Default baseline value for all glyphs. This value can be from 0 through 31.'),
        ('GlyphID', 'StandardGlyph', None, None,
    ...
    ('LigatureCaretsFormat0', [
        ...
        ('AATLookup(LigCaretDistances)', 'Carets', None, None,
    ...
    ('LigatureCaretsFormat1', [
        ('uint16', 'Format', None, None,
         'Format of the ligature caret table. Format 0 indicates division points are distances in font units, Format 1 indicates division points are indexes of control points.'),
        ('AATLookup(LigCaretPoints)', 'Carets', None, None,
    ...
    ('LigCaretDistances', [
        ...
        ('int16', 'DivisionPoint', 'DivsionPointCount', 0,
    ...
    ('MortSubtable', [
        ...
        ('Flags32', 'SubFeatureFlags', None, None,
    ...
    ('MorphFeature', [
        ...
        ('Flags32', 'DisableFlags', None, None,
    ...
    ('GlyphPropertiesFormat0', [
        ...
        ('uint16', 'DefaultProperties', None, None,
    ...
    ('OpticalBoundsFormat0', [
        ...
        ('AATLookup(OpticalBoundsDeltas)', 'OpticalBoundsDeltas', None, None,
    ...
    ('OpticalBoundsFormat1', [
        ...
        ('AATLookup(OpticalBoundsPoints)', 'OpticalBoundsPoints', None, None,
    ...
    ('COLR', [
        ...
        ('LOffset', 'BaseGlyphList', None, 'Version >= 1',
        ...
        ('LOffsetTo(DeltaSetIndexMap)', 'VarIndexMap', None, 'Version >= 1',
    ...
    ('PaintFormat5', [
        ...
        ('LOffset24To(VarColorLine)', 'ColorLine', None, None,
    ...
    ('PaintFormat32', [
        ...
        ('LOffset24To(Paint)', 'SourcePaint', None, None,
        ...
        ('LOffset24To(Paint)', 'BackdropPaint', None, None,
