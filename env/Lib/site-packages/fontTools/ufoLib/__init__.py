...
class UFOWriter(UFOReader):
	...
	fileCreator = property(_get_fileCreator,
...
fontInfoAttributesVersion2ValueData = {
	...
	"openTypeHeadFlags": dict(type="integerList", valueValidator=genericIntListValidator,
	...
	"openTypeOS2Selection": dict(type="integerList", valueValidator=genericIntListValidator,
	...
	"openTypeOS2UnicodeRanges": dict(type="integerList", valueValidator=genericIntListValidator,
									 valueOptions=fontInfoOpenTypeOS2UnicodeRangesOptions),
	"openTypeOS2CodePageRanges": dict(type="integerList", valueValidator=genericIntListValidator,
	...
	"openTypeOS2Type": dict(type="integerList", valueValidator=genericIntListValidator,
