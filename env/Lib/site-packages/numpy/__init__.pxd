...
cdef extern from "numpy/arrayobject.h":
    ...
    ctypedef class numpy.flatiter[object PyArrayIterObject,
    check_size ignore]:
        # Use through macros
        pass

    ctypedef class numpy.broadcast[object PyArrayMultiIterObject,
    check_size ignore]:
        cdef int numiter
...
cdef extern from "numpy/ufuncobject.h":
    ...
    ctypedef class numpy.ufunc[object PyUFuncObject,
    check_size ignore]:
        cdef:
            int nin, nout, nargs
            int identity
